...
- `CrokCode` (preserve casing in prose; keep `crokcode` only when it is part of commands, package names, paths, or code)
- `OpenCode Zen`
- `CrokCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `crokcode` in prose when referring to the product name; use `CrokCode`
