...
- `CrokCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `crokcode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `CrokCode` in prose, `crokcode` only for exact technical identifiers
...
- Avoid changing `crokcode` to `CrokCode` inside commands, URLs, package names, or code literals
