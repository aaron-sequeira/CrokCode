...
- Do not replace private `packages/opencode` imports with `@crokcode/core`
...
- The package has no dependency on `opencode`, `@crokcode/cli`, or
  `@crokcode/core`.
...
rg '@crokcode/core|packages/opencode|packages/cli' packages/tui
