...
- Canonical tagged tool file sources in `@crokcode/llm`.
...
- Canonicalize ambient instruction traversal boundaries, honor `CROKCODE_DISABLE_PROJECT_CONFIG`, and make non-empty aggregate updates explicitly supersede previously loaded instructions.
