...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "CROKCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/crokcode/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/crokcode (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/crokcode/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/crokcode/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const CROKCODE_DB|CROKCODE_DB|CROKCODE_DEV|Global\\.Path\\.data|data =" in packages/crokcode/src (115 matches)',
  },
] as const
