...
export const Definitions = {
  ...
  editor_toggle: keybind("enter,space", "Open the selected editor file or folder"),
  editor_conflict_keep: keybind("k", "Keep the editor buffer when the file changed on disk"),
  editor_conflict_take: keybind("t", "Take the version on disk when the file changed"),
  editor_conflict_diff: keybind("d", "Diff the file that changed on disk"),
  ...
  input_delete_word_backward: keybind("ctrl+w,ctrl+backspace,ctrl+h,alt+backspace", "Delete word backward in input"),
...
export const CommandMap = {
  ...
  editor_conflict_keep: "editor.conflict.keep",
  editor_conflict_take: "editor.conflict.take",
  editor_conflict_diff: "editor.conflict.diff",
  theme_list: "theme.switch",
  theme_switch_mode: "theme.switch_mode",
  theme_mode_lock: "theme.mode.lock",
  sidebar_toggle: "session.sidebar.toggle",
  scrollbar_toggle: "session.toggle.scrollbar",
  status_view: "crokcode.status",
  debug_view: "crokcode.debug",
