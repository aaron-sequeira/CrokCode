...
import defaultSoundPath from "@crokcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@crokcode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@crokcode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@crokcode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@crokcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@crokcode/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "crokcode"
const DEFAULT_PACK_ID = "crokcode.default"
