 ...
 *   "@crokcode/ServerAuthConfig",
 *   {
 *     password: Config.string("CROKCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CROKCODE_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
