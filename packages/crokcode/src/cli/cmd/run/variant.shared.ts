...
//
// The saved variant persists across sessions in ~/.local/state/crokcode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@crokcode/RunVariant") {}
