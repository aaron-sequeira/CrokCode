...
import { normalizePromptContent } from "@crokcode/tui/editor"
...
import { CROKCODE_BASE_MODE, useBindings } from "@crokcode/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close CrokCode" } satisfies SlashOption,
    ]
