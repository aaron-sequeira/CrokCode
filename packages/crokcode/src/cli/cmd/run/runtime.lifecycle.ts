...
import { openEditor } from "@crokcode/tui/editor"
import { registerCrokcodeKeymap } from "@crokcode/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerCrokcodeKeymap(keymap, renderer, input.tuiConfig)
