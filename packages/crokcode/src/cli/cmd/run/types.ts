// Shared type vocabulary for the direct interactive mode (`crokcode --mini`).
//
...
import type { CrokcodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@crokcode/sdk/v2"
import type { TuiConfig } from "@crokcode/tui/config"
...
type PromptModel = Parameters<CrokcodeClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<CrokcodeClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<CrokcodeClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<CrokcodeClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<CrokcodeClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<CrokcodeClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<CrokcodeClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<CrokcodeClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<CrokcodeClient["question"]["reject"]>[0]
