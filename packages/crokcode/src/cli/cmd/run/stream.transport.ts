...
import type { Event, GlobalEvent, CrokcodeClient } from "@crokcode/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@crokcode/RunStreamTransport") {}
