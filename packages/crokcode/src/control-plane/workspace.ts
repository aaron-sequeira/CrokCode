...
import { EventSequenceTable, EventTable } from "@crokcode/core/event/sql"
...
import { WorkspaceEvent } from "@crokcode/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CROKCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CROKCODE_WORKSPACE_ID: config.id,
        CROKCODE_EXPERIMENTAL_WORKSPACES: "true",
