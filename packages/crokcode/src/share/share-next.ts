...
import type * as SDK from "@crokcode/sdk/v2"
...
import { SessionShareTable } from "@crokcode/core/share/sql"
...
const disabled = process.env["CROKCODE_DISABLE_SHARE"] === "true" || process.env["CROKCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/ShareNext") {}
