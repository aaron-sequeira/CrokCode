import type { Hooks, PluginInput } from "@crokcode/plugin"
import type { Model } from "@crokcode/sdk/v2"
import { InstallationVersion } from "@crokcode/core/installation/version"
import { OauthCallbackPage } from "@crokcode/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. CrokCode will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
