...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@crokcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@crokcode/ACPDirectory") {}
