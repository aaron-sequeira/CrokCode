...
import { SessionStatusEvent } from "@crokcode/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/SessionStatus") {}
