...
import { llmClient } from "@crokcode/core/effect/app-node-platform"
...
import type { LLMEvent } from "@crokcode/llm"
import { LLMClient } from "@crokcode/llm/route"
import type { LLMClientService } from "@crokcode/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via crokcode's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @crokcode/llm. It
