import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@crokcode/llm"
...
// Move this extraction into @crokcode/llm when Copilot is handled by the native runtime.
