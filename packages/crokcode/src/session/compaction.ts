...
import { buildPrompt } from "@crokcode/core/session/compaction"
import { SessionCompactionEvent } from "@crokcode/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/SessionCompaction") {}
