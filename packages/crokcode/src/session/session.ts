...
import { locationServiceMapLayer } from "@crokcode/core/location-services"
...
import { PartTable, SessionTable } from "@crokcode/core/session/sql"
...
import { NonNegativeInt, optional } from "@crokcode/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".crokcode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/Session") {}
