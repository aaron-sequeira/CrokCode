...
export class Service extends Context.Service<Service, Interface>()("@crokcode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __CROKCODE_PHOTON_WASM_PATH?: string }).__CROKCODE_PHOTON_WASM_PATH =
