...
import { AbsolutePath, type DeepMutable } from "@crokcode/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".crokcode", "plans", "*.md")]: "allow",
