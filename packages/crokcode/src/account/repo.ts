...
import { AccountStateTable, AccountTable } from "@crokcode/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/AccountRepo") {}
