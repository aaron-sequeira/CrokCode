...
import { makeApi } from "@crokcode/protocol/api"
import { LocationMiddleware } from "@crokcode/server/location"
import { SessionLocationMiddleware } from "@crokcode/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("crokcode-root")
...
export const InstanceHttpApi = HttpApi.make("crokcode-instance")
...
export const CrokCodeHttpApi = HttpApi.make("opencode")
