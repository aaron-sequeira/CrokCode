...
>()("@crokcode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@crokcode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.CROKCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.CROKCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-crokcode-directory"] || process.cwd()
}
