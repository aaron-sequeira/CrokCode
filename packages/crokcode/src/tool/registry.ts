...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@crokcode/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.crokcode || flags.exa || flags.parallel
}
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/ToolRegistry") {}
