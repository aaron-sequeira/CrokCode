...
Practical reference for the current tool-migration state in `packages/crokcode`.
...
Tool tests should use the existing Effect helpers in `packages/crokcode/test/lib/effect.ts`:
