...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/crokcode`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy crokcode service removed
