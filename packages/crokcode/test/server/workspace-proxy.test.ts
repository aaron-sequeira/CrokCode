...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips crokcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-crokcode-directory"]).toBeUndefined()
      expect(forwarded["x-crokcode-workspace"]).toBeUndefined()
