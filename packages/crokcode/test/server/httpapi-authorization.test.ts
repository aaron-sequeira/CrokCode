...
const noAuthLayer = ServerAuth.Config.configLayer({ password: Option.none(), username: "crokcode" })
const secretLayer = ServerAuth.Config.configLayer({ password: Option.some("secret"), username: "crokcode" })
