...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips crokcode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-crokcode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-crokcode-directory")).toBeNull()
      expect(result.get("x-crokcode-workspace")).toBeNull()
