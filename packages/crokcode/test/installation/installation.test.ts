...
import { InstallationChannel } from "@crokcode/core/installation/version"
  ...
  describe("latest", () => {
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("anomalyco/tap/crokcode")) return ""
          if (cmd === "brew" && args.includes("--formula") && args.includes("opencode")) return "crokcode"
          return ""
        },
      ),
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("anomalyco/tap/crokcode") && args.includes("--formula")) return "crokcode"
