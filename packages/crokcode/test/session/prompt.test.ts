...
import { SessionMessageTable } from "@crokcode/core/session/sql"
...
import { LocationServiceMap, locationServiceMapLayer } from "@crokcode/core/location-services"
...
it.instance("does not loop empty assistant turns for a simple reply", () =>
  Effect.gen(function* () {
    ...
    yield* llm.text("packages/crokcode/src/session/processor.ts")
