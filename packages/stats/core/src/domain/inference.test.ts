...
describe("inference stat normalization", () => {
  ...
  test("uses provider.model to resolve crokcode route providers", () => {
  ...
  test("provider aggregates never keep crokcode as the provider", () => {
  ...
  test("geo aggregates never keep crokcode or big-pickle dimensions", () => {
