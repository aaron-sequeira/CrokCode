...
const en = {
  "app.title": "AI Model Usage Rankings | CrokCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "CrokCode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star CrokCode on GitHub",
  "header.github": "GitHub",
  "header.tryCrokCode": "Try CrokCode",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | CrokCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Reading model availability and recent CrokCode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in CrokCode",
  ...
  "lab.shareOfUsage": "{{share}} of recent CrokCode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | CrokCode Data",
  "model.description":
