export const dict = {
  "app.title": "Rankingi użycia modeli AI | CrokCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "Znak słowny CrokCode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę CrokCode na GitHub",
  "header.github": "GitHub",
  "header.tryCrokCode": "Wypróbuj CrokCode",
  ...
  "footer.homeAria": "Strona główna CrokCode",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | CrokCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia CrokCode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w CrokCode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia CrokCode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów CrokCode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | CrokCode Data",
  "model.description":
