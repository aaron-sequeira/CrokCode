export const dict = {
  "app.title": "Ranking de uso de modelos de IA | CrokCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo do CrokCode Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao CrokCode no GitHub",
  "header.github": "GitHub",
  "header.tryCrokCode": "Experimente o CrokCode",
  ...
  "footer.homeAria": "Início do CrokCode",
  ...
  "modal.title": "Newsletter do CrokCode",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | CrokCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do CrokCode.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no CrokCode",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do CrokCode",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do CrokCode nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | CrokCode Data",
  "model.description":
