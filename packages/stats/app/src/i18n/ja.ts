...
export const dict = {
  ...
  "header.githubAria": "GitHubでCrokCodeにスターを付ける",
  "header.github": "GitHub",
  "header.tryCrokCode": "CrokCodeを試す",
  ...
  "lab.title": "{{lab}} AIモデル使用量とランキング | CrokCodeデータ",
  "lab.description":
    "OpenCode Goで使用されている{{lab}}モデルを、トークン使用量、モデルランキング、コンテキストウィンドウ、リリース日、コスト、モデル別データで比較できます。",
  "lab.loadingTitle": "モデルラボ",
  "lab.loadingDescription": "モデルの利用可否と最近のCrokCode使用状況を読み込んでいます。",
  "lab.notFound": "このラボに一致するモデルはありません。",
  "lab.heroPrefix": "CrokCodeで使用されている{{count}}件の{{lab}}モデルを確認",
  ...
  "lab.shareOfUsage": "最近のCrokCode使用量の{{share}}",
  "lab.usageTitle": "{{lab}}のトークン使用量",
  "lab.usageDescription": "過去2か月の日次CrokCodeトークン量。",
  ...
  "lab.usage": "使用量",
  "lab.share": "シェア",
  "model.title": "{{model}}の使用量、コスト、ランク | CrokCodeデータ",
  "model.description":
