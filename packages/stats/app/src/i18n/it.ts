export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | CrokCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo CrokCode Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a CrokCode su GitHub",
  "header.github": "GitHub",
  "header.tryCrokCode": "Prova CrokCode",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | CrokCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di CrokCode.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in CrokCode",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di CrokCode",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token CrokCode negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | CrokCode Data",
  "model.description":
