export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | CrokCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo textual de CrokCode Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a CrokCode en GitHub",
  "header.github": "GitHub",
  "header.tryCrokCode": "Probar CrokCode",
  ...
  "footer.homeAria": "Inicio de CrokCode",
  ...
  "modal.title": "Boletín de CrokCode",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | CrokCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de CrokCode.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en CrokCode",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de CrokCode",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de CrokCode durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | CrokCode Data",
  "model.description":
