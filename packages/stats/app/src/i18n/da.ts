export const dict = {
  "app.title": "Ranglister for brug af AI-modeller | CrokCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "CrokCode Data-ordmærke på en mørk mønstret baggrund",
  ...
  "header.githubAria": "Giv CrokCode en stjerne på GitHub",
  "header.github": "GitHub",
  "header.tryCrokCode": "Prøv CrokCode",
  ...
  "footer.homeAria": "CrokCode-forside",
  ...
  "modal.title": "CrokCode-nyhedsbrev",
  ...
  "home.uniqueUsersDescription": "Daglige unikke CrokCode Go-brugere efter model.",
  ...
  "lab.title": "{{lab}} AI-modelbrug og ranglister | CrokCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Læser modeltilgængelighed og seneste CrokCode-brug.",
  "lab.notFound": "Ingen modeller matchede dette lab.",
  "lab.heroPrefix": "Udforsk {{count}} {{lab}}-modeller brugt i CrokCode",
  ...
  "lab.shareOfUsage": "{{share}} af den seneste CrokCode-brug",
  "lab.usageTitle": "{{lab}}-tokenbrug",
  "lab.usageDescription": "Daglig CrokCode-tokenvolumen over de sidste to måneder.",
  ...
  "lab.usage": "Brug",
  "lab.share": "Andel",
  "model.title": "{{model}} brug, omkostning og rang | CrokCode Data",
  "model.description":
    "Se CrokCode Go-brugsdata for {{model}}, inklusive tokenvolumen, ugentlig rang, tokenmix, omkostninger, cacheandel, sessioner, geografiske opdelinger og lignende modeller.",
  ...
  "model.catalogFallback":
    "Modelfakta fra det fælles modelindeks. CrokCode Go-brug vises, når denne model har aktivitet.",
  "model.unranked": "Ikke rangeret i sidste uges CrokCode Go-brug",
  "model.ranked": "Rangeret #{{rank}} i sidste uges CrokCode Go-brug",
  "model.observedVolume": "med {{share}} af observeret 2M-volumen.",
  "model.weights": "Modelvægte: {{label}}",
  "model.rank": "7D-rang",
  "model.profile": "Modelprofil",
  "model.listed": "Opført",
  "model.noCurrentUsage": "Ingen CrokCode Go-brug i det aktuelle datavindue.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Seneste CrokCode Go-tokens, unikke brugere og markedsposition.",
  "model.noSummaryTitle": "Ingen brugsoversigt",
  "model.noSummaryDescription": "Denne model har endnu ingen CrokCode Go-brugsrækker.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daglig CrokCode Go-tokenvolumen i det seneste tomånedersvindue.",
  ...
  "model.usersDescription": "Daglige unikke CrokCode Go-brugere i det seneste tomånedersvindue.",
  ...
  "model.efficiencyDescription": "Omkostning, cacheadfærd og gennemsnitlig CrokCode Go-sessionsform.",
  ...
  "model.geoDescription": "CrokCode Go-modeltokens brugt efter land.",
  "model.noGeoTitle": "Ingen geodata",
  "model.noGeoDescription": "Ingen CrokCode Go-georækker matchede denne model.",
  "model.worldMap": "Verdenskort over modeltokenbrug efter land",
  "model.peersDescription": "Nærliggende modeller efter seneste CrokCode Go-tokenvolumen.",
