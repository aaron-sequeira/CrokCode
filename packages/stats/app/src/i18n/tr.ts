export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | CrokCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde CrokCode Data logosu",
  ...
  "header.githubAria": "GitHub'da CrokCode'a yıldız ver",
  "header.github": "GitHub",
  "header.tryCrokCode": "CrokCode'u dene",
  ...
  "footer.homeAria": "CrokCode ana sayfası",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | CrokCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Model kullanılabilirliği ve son CrokCode kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "CrokCode'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son CrokCode kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük CrokCode token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | CrokCode Data",
  "model.description":
