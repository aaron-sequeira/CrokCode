export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | CrokCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logo textuel CrokCode Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à CrokCode sur GitHub",
  "header.github": "GitHub",
  "header.tryCrokCode": "Essayer CrokCode",
  ...
  "footer.homeAria": "Accueil CrokCode",
  ...
  "modal.title": "Newsletter CrokCode",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | CrokCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'CrokCode.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans CrokCode",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'CrokCode",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens CrokCode sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | CrokCode Data",
  "model.description":
