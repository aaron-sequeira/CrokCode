import crokcodeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const themeStorageKey = "crokcode:stats-theme"
      ...
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://opencode.ai/">
            <strong>{i18n.t("header.tryCrokCode")}</strong>
          </a>
          <button
...
function CrokCodeMark() {
  return (
    <svg data-slot="crokcode-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={crokcodeWordmarkDark} alt="CrokCode" />
          <button
