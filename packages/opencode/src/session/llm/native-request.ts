import type { JsonSchema, LLMRequest, ProviderMetadata } from "@crokcode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@crokcode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @crokcode/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
