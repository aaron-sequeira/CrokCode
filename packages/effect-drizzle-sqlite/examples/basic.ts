...
class Database extends Context.Service<Database, DatabaseShape>()("@crokcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@crokcode/example/UserStore") {
