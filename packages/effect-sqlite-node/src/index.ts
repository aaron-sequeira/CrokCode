...
export const TypeId: TypeId = "~@crokcode/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@crokcode/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@crokcode/effect-sqlite-node/NodeSqliteClient")
