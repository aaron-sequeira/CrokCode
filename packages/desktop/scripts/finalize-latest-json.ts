...
const releaseId = process.env.CROKCODE_RELEASE
if (!releaseId) throw new Error("CROKCODE_RELEASE is required")

const version = process.env.CROKCODE_VERSION
if (!version) throw new Error("CROKCODE_VERSION is required")
...
const macxTarGz = "crokcode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "crokcode-desktop-mac-arm64.app.tar.gz"
