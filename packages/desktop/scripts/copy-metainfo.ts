...
const appId = channel === "prod" ? "ai.crokcode.desktop" : `ai.crokcode.desktop.${channel}`
const productName = channel === "prod" ? "CrokCode" : `CrokCode ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      CrokCode is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
