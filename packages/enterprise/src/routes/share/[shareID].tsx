import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@crokcode/sdk/v2"
import { SessionTurn } from "@crokcode/session-ui/session-turn"
import { SessionReview } from "@crokcode/session-ui/session-review"
import { DataProvider } from "@crokcode/session-ui/context"
import { FileComponentProvider } from "@crokcode/ui/context/file"
import { WorkerPoolProvider } from "@crokcode/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@crokcode/ui/logo"
import { IconButton } from "@crokcode/ui/icon-button"
import { ProviderIcon } from "@crokcode/ui/provider-icon"
import { iife } from "@crokcode/core/util/iife"
import { Binary } from "@crokcode/core/util/binary"
import { NamedError } from "@crokcode/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@crokcode/ui/tabs"
import { MessageNav } from "@crokcode/session-ui/message-nav"
import { FileSSR } from "@crokcode/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@crokcode/session-ui/pierre/worker").then((m) => ({
          ...
          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | CrokCode</Title>
              </Show>
              <Meta name="description" content="crokcode - The AI coding agent built for the terminal." />
