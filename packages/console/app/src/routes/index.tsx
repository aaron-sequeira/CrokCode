...
import video from "../asset/lander/crokcode-min.mp4"
import videoPoster from "../asset/lander/crokcode-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">anomalyco/tap/crokcode</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  <Tabs.Content as="pre" data-slot="panel" value="paru">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">crokcode</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
