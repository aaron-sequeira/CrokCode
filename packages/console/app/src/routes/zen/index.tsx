...
import compareVideo from "../../asset/lander/crokcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/crokcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="crokcode:auth" content={loggedin() ? "true" : "false"} />
