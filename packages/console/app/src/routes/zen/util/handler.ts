...
import { and, Database, eq, isNull, lt, or, sql } from "@crokcode/console-core/drizzle/index.js"
import { KeyTable } from "@crokcode/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@crokcode/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@crokcode/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@crokcode/console-core/util/date.js"
import { Identifier } from "@crokcode/console-core/identifier.js"
import { Billing } from "@crokcode/console-core/billing.js"
import { Actor } from "@crokcode/console-core/actor.js"
import { WorkspaceTable } from "@crokcode/console-core/schema/workspace.sql.js"
import { ZenData } from "@crokcode/console-core/model.js"
import { Subscription } from "@crokcode/console-core/subscription.js"
import { BlackData } from "@crokcode/console-core/black.js"
import { UserTable } from "@crokcode/console-core/schema/user.sql.js"
import { ModelTable } from "@crokcode/console-core/schema/model.sql.js"
import { ProviderTable } from "@crokcode/console-core/schema/provider.sql.js"
...
import { LiteData } from "@crokcode/console-core/lite.js"
import { Resource } from "@crokcode/console-resource"
...
import { Workspace } from "@crokcode/console-core/workspace.js"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-crokcode-session") ?? ""
    const requestId = input.request.headers.get("x-crokcode-request") ?? ""
    const ocClient = input.request.headers.get("x-crokcode-client") ?? ""
    const projectId = input.request.headers.get("x-crokcode-project") ?? ""
    ...
    */
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWithRetryableStatus(
        reqUrl,
        {
          ...
          headers: (() => {
            ...
            headers.delete("x-crokcode-request")
            headers.delete("x-crokcode-session")
            headers.delete("x-crokcode-project")
            headers.delete("x-crokcode-client")
            return headers
          })(),
          body: reqBody,
      ...
      if (isNewInference) {
        const resEndpointId = res.headers.get("x-crokcode-endpoint-id")
        const resEndpointModelId = res.headers.get("x-crokcode-upstream-model-id")
