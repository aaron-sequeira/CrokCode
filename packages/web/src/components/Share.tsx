...
import { IconCrokcode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "crokcode/session/message-v2"
import type { Message } from "crokcode/session/message"
import type { Session } from "crokcode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.crokcode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.crokcode_name}>
                    <IconCrokcode width={16} height={16} />
                  </div>
