---
title: TUI
description: Korištenje korisničkog interfejsa CrokCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CrokCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje CrokCode pokreće TUI za trenutni direktorij.
...
Kada koristite CrokCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u CrokCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz CrokCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `crokcode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo CrokCode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `crokcode.default`.
