...
Kreiraj `.crokcode/commands/test.md`:
...
Možete dodati prilagođene komande kroz CrokCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom CrokCode [config](/docs/config):
...
- Globalno: `~/.config/crokcode/commands/`
- Po projektu: `.crokcode/commands/`
...
CrokCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
