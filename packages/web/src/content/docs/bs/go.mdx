...
Go radi kao bilo koji drugi provajder u CrokCode-u. Pretplatite se na OpenCode Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili CrokCode.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa CrokCode-om.
:::
...
OpenCode Go radi kao bilo koji drugi provajder u CrokCode-u.
...
[Model id](/docs/config/#models) u vašoj CrokCode konfiguraciji
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz CrokCode koristite i bilo kojeg drugog provajdera.
