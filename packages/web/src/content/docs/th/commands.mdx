...
สร้าง `.crokcode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ CrokCode:
...
- ระดับผู้ใช้ (Global): `~/.config/crokcode/commands/`
- ระดับโปรเจ็กต์: `.crokcode/commands/`
...
CrokCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
