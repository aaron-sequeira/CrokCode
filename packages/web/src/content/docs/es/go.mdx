...
Go funciona como cualquier otro proveedor en CrokCode. Te suscribes a OpenCode Go y
...
OpenCode Go funciona como cualquier otro proveedor en CrokCode.
...
El [ID del modelo](/docs/config/#models) en tu configuración de CrokCode
...
4. Evitar la **dependencia (lock-in)** al permitirte usar también cualquier otro proveedor con CrokCode.
