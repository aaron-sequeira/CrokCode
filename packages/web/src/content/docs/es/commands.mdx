...
Crear `.crokcode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración CrokCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su CrokCode [config](/docs/config):
...
- Por proyecto: `.crokcode/commands/`
...
crokcode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
