---
title: Zen
description: Lista seleccionada de modelos proporcionada por CrokCode.
---
...
OpenCode Zen es una lista de modelos probados y verificados proporcionada por el equipo de CrokCode.

Zen funciona como cualquier otro proveedor en CrokCode. Inicias sesión en OpenCode Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con CrokCode.
:::
...
OpenCode Zen funciona como cualquier otro proveedor en CrokCode.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de CrokCode
usa el formato `crokcode/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`crokcode/gpt-5.5` en tu configuración.
...
- DeepSeek V4 Flash Free está disponible en CrokCode por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en CrokCode por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- North Mini Code Free está disponible en CrokCode por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en CrokCode por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en CrokCode por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con CrokCode.
