---
title: LSP-servere
description: crokcode integreres med LSP-serverne dine.
---

CrokCode kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

CrokCode kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `CROKCODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og crokcode åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i CrokCode-konfigurasjonen.
