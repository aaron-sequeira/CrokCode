...
Opprett `.crokcode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom CrokCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i CrokCode [config](/docs/config):
...
- Per prosjekt: `.crokcode/commands/`
...
CrokCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
