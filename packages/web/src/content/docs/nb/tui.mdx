---
title: TUI
description: Bruke crokcode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CrokCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre CrokCode starter TUI for gjeldende katalog.
...
Når du bruker CrokCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til CrokCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt CrokCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `crokcode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge CrokCode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `crokcode.default`.
