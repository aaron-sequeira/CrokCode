...
Agentferdigheter lar CrokCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går crokcode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
crokcode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `crokcode.json`:
