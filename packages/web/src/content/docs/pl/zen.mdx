---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez CrokCode.
---
...
OpenCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół CrokCode.

Zen działa jak każdy inny dostawca w CrokCode. Logujesz się do OpenCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z CrokCode.
:::
...
OpenCode Zen działa jak każdy inny dostawca w CrokCode.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji CrokCode używa formatu
`crokcode/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`crokcode/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w CrokCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w CrokCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w CrokCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w CrokCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w CrokCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w CrokCode także dowolnego innego dostawcy.
