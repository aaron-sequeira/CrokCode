---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące crokcode.
---

Funkcja udostępniania crokcode umożliwia tworzenie publicznych linków do konwersacji crokcode, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
crokcode obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie crokcode korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `crokcode.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu crokcode w Twojej organizacji.
