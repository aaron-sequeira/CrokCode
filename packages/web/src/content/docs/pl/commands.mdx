...
Utwórz `.crokcode/commands/test.md`:
...
Możesz zdefiniować polecenia w `crokcode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji crokcode:
...
- Globalnie: `~/.config/crokcode/commands/`
- Na projekt: `.crokcode/commands/`
...
crokcode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
