---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala crokcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

crokcode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie crokcode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI crokcode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do crokcode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij crokcode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `crokcode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo CrokCode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `crokcode.default`.
