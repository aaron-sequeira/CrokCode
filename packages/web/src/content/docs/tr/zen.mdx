---
title: Zen
description: crokcode tarafından sağlanan seçilmiş modeller listesi.
---
...
OpenCode Zen, CrokCode ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, CrokCode'daki diğer sağlayıcılar gibi çalışır. OpenCode Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve CrokCode kullanmak için buna ihtiyacınız yoktur.
...
:::tip
CrokCode ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
OpenCode Zen, CrokCode'daki diğer sağlayıcılar gibi çalışır.
...
CrokCode yapılandırmanızdaki [model id](/docs/config/#models) `crokcode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `crokcode/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için CrokCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için CrokCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için CrokCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için CrokCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için CrokCode'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca CrokCode ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
