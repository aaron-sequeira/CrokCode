---
title: Özel Araçlar
description: LLM'un crokcode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. crokcode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.crokcode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/crokcode/tools/` içine yerleştirerek.
