---
title: Zen
description: Curated list of models provided by CrokCode.
---
...
OpenCode Zen is a list of tested and verified models provided by the CrokCode team.

Zen works like any other provider in CrokCode. You login to OpenCode Zen and get
...
:::tip
We tested a select group of models and providers that work well with CrokCode.
:::
...
OpenCode Zen works like any other provider in CrokCode.
...
The [model id](/docs/config/#models) in your CrokCode config
uses the format `crokcode/<model-id>`. For example, for GPT 5.5, you would
use `crokcode/gpt-5.5` in your config.
...
- DeepSeek V4 Flash Free is available on CrokCode for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on CrokCode for a limited time. The team is using this time to collect feedback and improve the model.
- North Mini Code Free is available on CrokCode for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on CrokCode for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on CrokCode for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with CrokCode as well.
