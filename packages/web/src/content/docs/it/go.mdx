...
Go funziona come qualsiasi altro provider in CrokCode. Ti abboni a OpenCode Go e
...
OpenCode Go funziona come qualsiasi altro provider in CrokCode.
...
Il [model id](/docs/config/#models) nella tua CrokCode config
...
4. Non avere **nessun lock-in**, permettendoti di utilizzare anche qualsiasi altro provider con CrokCode.
