...
Brug den til at bygge integrasjoner og kontrollere crokcode programmatisk.
...
Opret en forekomst av crokcode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `crokcode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av crokcode, kan du oprete en klientforekomst for at koble til den:
