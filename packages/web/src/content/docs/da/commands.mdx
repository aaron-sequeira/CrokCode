...
Opret `.crokcode/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem CrokCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din CrokCode [config](/docs/config):
...
- Globalt: `~/.config/crokcode/commands/`
- Pr. projekt: `.crokcode/commands/`
...
crokcode indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
