...
Go fungerer som enhver anden udbyder i CrokCode. Du abonnerer på OpenCode Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med CrokCode.
:::
...
OpenCode Go fungerer som enhver anden udbyder i CrokCode.
...
Dit [model id](/docs/config/#models) i din CrokCode config
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med CrokCode.
