---
title: TUI
description: Brug af CrokCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CrokCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre CrokCode starter TUI for den nuværende mappe.
...
Når du bruger CrokCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til CrokCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut CrokCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `crokcode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe CrokCode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `crokcode.default`.
