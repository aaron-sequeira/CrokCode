---
title: Zen
description: Liste organisée de modèles fournis par CrokCode.
---
...
OpenCode Zen est une liste de modèles testés et vérifiés fournie par l'équipe CrokCode.

Zen fonctionne comme n'importe quel autre fournisseur dans CrokCode. Vous vous connectez à OpenCode Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser CrokCode.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec CrokCode.
:::
...
OpenCode Zen fonctionne comme n'importe quel autre fournisseur dans CrokCode.
...
Le [model id](/docs/config/#models) dans votre configuration CrokCode utilise le format `crokcode/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `crokcode/gpt-5.5` dans votre configuration.
...
- DeepSeek V4 Flash Free est disponible sur CrokCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiMo-V2.5 Free est disponible sur CrokCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- North Mini Code Free est disponible sur CrokCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Ultra Free est disponible sur CrokCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur CrokCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec CrokCode également.
