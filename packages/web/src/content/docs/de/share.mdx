---
title: Teilen
description: Teile CrokCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu CrokCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht CrokCode Folgendes:
...
CrokCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt CrokCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`crokcode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du crokcode in deiner Organisation einsetzt.
