---
title: Zen
description: Kuratierte Modellliste direkt von CrokCode.
---
...
OpenCode Zen ist eine Liste von getesteten und verifizierten Modellen, die vom CrokCode-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in CrokCode. Du meldest dich bei OpenCode Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um CrokCode zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit CrokCode funktionieren.
:::
...
OpenCode Zen funktioniert wie jeder andere Provider in CrokCode.
...
Die [Model-ID](/docs/config/#models) in deiner CrokCode-Konfiguration verwendet das Format `crokcode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `crokcode/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf CrokCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf CrokCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- North Mini Code Free ist für begrenzte Zeit auf CrokCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf CrokCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf CrokCode verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit CrokCode auch jeden anderen Provider zu verwenden.
