...
O Go funciona como qualquer outro provedor no CrokCode. Você assina o OpenCode Go e
...
O OpenCode Go funciona como qualquer outro provedor no CrokCode.
...
O [ID do modelo](/docs/config/#models) na sua configuração do CrokCode
...
4. Não ter **nenhuma restrição de fornecedor (lock-in)**, permitindo que você use qualquer outro provedor com o CrokCode também.
