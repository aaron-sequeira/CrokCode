---
title: Zen
description: Lista selecionada de modelos fornecidos pelo CrokCode.
---
...
O OpenCode Zen é uma lista de modelos testados e verificados fornecidos pela equipe do CrokCode.

O Zen funciona como qualquer outro provedor no CrokCode. Você faz login no OpenCode Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o CrokCode.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o CrokCode.
:::
...
O OpenCode Zen funciona como qualquer outro provedor no CrokCode.
...
O [model id](/docs/config/#models) na sua configuração do CrokCode usa o formato `crokcode/<model-id>`. Por exemplo, para GPT 5.5, você usaria `crokcode/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no CrokCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no CrokCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- North Mini Code Free está disponível no CrokCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no CrokCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no CrokCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o CrokCode também.
