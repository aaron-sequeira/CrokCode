...
Schema-first LLM core for crokcode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@crokcode/llm"
import { OpenAI } from "@crokcode/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@crokcode/llm/providers"
