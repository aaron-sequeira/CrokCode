import { CrokCode } from "@crokcode/client/effect"
...
import { createEmbeddedRoutes } from "@crokcode/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("CrokCode.create")(function* () {
  ...
  const client = yield* CrokCode.make({ baseUrl: "http://opencode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/sdk-next/CrokCode") {}
