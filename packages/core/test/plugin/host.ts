import type { PluginContext } from "@crokcode/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@crokcode/sdk/v2/types"
