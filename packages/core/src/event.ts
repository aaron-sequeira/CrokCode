...
import type { Data, Definition, Payload } from "@crokcode/schema/event"
...
import { Durable } from "@crokcode/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@crokcode/schema/event").ID
export type { Data, Definition, Payload } from "@crokcode/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/Event") {}
