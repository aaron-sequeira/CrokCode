...
import { PermissionSaved } from "@crokcode/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/v2/PermissionSaved") {}
