...
import { type Model } from "@crokcode/llm"
import * as AnthropicMessages from "@crokcode/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@crokcode/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@crokcode/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@crokcode/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/v2/SessionRunnerModel") {}
