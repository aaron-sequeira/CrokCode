...
import { ListAnchor } from "@crokcode/schema/session"
...
import { SessionDurable } from "@crokcode/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/v2/Session") {}
