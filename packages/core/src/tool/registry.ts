...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@crokcode/llm"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/v2/ToolRegistry") {}
