...
import { ToolFailure } from "@crokcode/llm"
...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.CROKCODE_WEBSEARCH_PROVIDER === "exa" || process.env.CROKCODE_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.CROKCODE_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("CROKCODE_EXPERIMENTAL") || truthy("CROKCODE_ENABLE_EXA") || truthy("CROKCODE_EXPERIMENTAL_EXA"),
    enableParallel: truthy("CROKCODE_ENABLE_PARALLEL") || truthy("CROKCODE_EXPERIMENTAL_PARALLEL"),
