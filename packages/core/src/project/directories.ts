...
import type { EffectDrizzleSqlite } from "@crokcode/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/ProjectDirectories") {}
