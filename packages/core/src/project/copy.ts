...
import { Event } from "@crokcode/schema/project-directories"
import { ProjectCopy } from "@crokcode/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/ProjectCopy") {}
