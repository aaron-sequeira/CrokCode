...
export class Service extends Context.Service<Service, Interface>()("@crokcode/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.CROKCODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
