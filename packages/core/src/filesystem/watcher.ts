...
import { FileSystemWatcher } from "@crokcode/schema/filesystem-watcher"
...
declare const CROKCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CROKCODE_LIBC === "undefined" ? undefined : CROKCODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@crokcode/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CROKCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.CROKCODE_EXPERIMENTAL_FILEWATCHER)) {
