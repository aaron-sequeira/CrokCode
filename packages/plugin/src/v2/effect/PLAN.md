...
- Effect plugins import `@crokcode/plugin/v2/effect`, not `@crokcode/core`.
- Public domain values use generated `@crokcode/sdk` types.
...
- Define `PluginHost` domain capabilities in `@crokcode/plugin/v2/effect`.
