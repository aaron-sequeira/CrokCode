...
const GLOBAL_STORAGE = "crokcode.global.dat"
const WINDOW_STORAGE = "crokcode.window"
const LOCAL_PREFIX = "crokcode."
...
function workspaceStorage(dir: string) {
  ...
  return `crokcode.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `crokcode.draft.${head}.${sum}.dat`
}
