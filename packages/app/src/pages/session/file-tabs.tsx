...
import type { FileSearchHandle } from "@crokcode/session-ui/file"
import { useFileComponent } from "@crokcode/ui/context/file"
import { cloneSelectedLineRange, previewSelectedLines } from "@crokcode/session-ui/pierre/selection-bridge"
import { createLineCommentController } from "@crokcode/session-ui/line-comment-annotations"
import { createLineCommentControllerV2 } from "@crokcode/session-ui/v2/line-comment-annotations-v2"
import { sampledChecksum } from "@crokcode/core/util/encode"
import { DropdownMenu } from "@crokcode/ui/dropdown-menu"
import { IconButton } from "@crokcode/ui/icon-button"
import { LineCommentV2OverflowIcon } from "@crokcode/ui/v2/line-comment-v2"
import { MenuV2 } from "@crokcode/ui/v2/menu-v2"
import { Tabs } from "@crokcode/ui/tabs"
import { ScrollView } from "@crokcode/ui/scroll-view"
  ...
  const renderFile = (source: string) => (
    <div class="relative overflow-hidden pb-40">
      <Dynamic
        ...
        search={search}
        class="select-text [--crokcode-diffs-bg:var(--v2-background-bg-base)]"
        media={{
          mode: "auto",
          path: path(),
          current: state()?.content,
