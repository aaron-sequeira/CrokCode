export const dict = {
  ...
  "dialog.provider.crokcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.crokcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.crokcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez CrokCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CrokCode.",
  ...
  "provider.connect.crokcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.crokcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.crokcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CrokCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CrokCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w crokcode.json",
  ...
  "dialog.server.description": "Przełącz serwer CrokCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingCrokcode": "Sprawdzanie CrokCode...",
  "wsl.onboarding.checkingCrokcodeIn": "Sprawdzanie CrokCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingCrokcode": "Aktualizowanie CrokCode...",
  "wsl.onboarding.updatingCrokcodeIn": "Aktualizowanie CrokCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateCrokcodeIn": "Zaktualizuj CrokCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateCrokcode": "Zaktualizuj CrokCode",
  "wsl.onboarding.crokcodeReadyIn": "CrokCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.crokcodeReady": "CrokCode jest gotowy.",
  "wsl.onboarding.installCrokcodeIn": "Zainstaluj CrokCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installCrokcode": "Zainstaluj CrokCode",
  ...
  "wsl.onboarding.distroStatus.crokcodeMissing": "CrokCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim CrokCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "CrokCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz CrokCode.",
  ...
  "toast.update.description": "Nowa wersja CrokCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CrokCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (crokcode.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: CrokCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "CrokCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer CrokCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CrokCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd CrokCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy CrokCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CrokCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CrokCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CrokCode.",
