export const dict = {
  ...
  "dialog.provider.crokcode.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.crokcode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.crokcodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por CrokCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en CrokCode.",
  ...
  "provider.connect.crokcodeZen.visit.prefix": "Visita ",
  "provider.connect.crokcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.crokcodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en CrokCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en CrokCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en crokcode.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de CrokCode se conecta esta app.",
  ...
  "wsl.onboarding.checkingCrokcode": "Comprobando CrokCode...",
  "wsl.onboarding.checkingCrokcodeIn": "Comprobando CrokCode en {{distro}}...",
  "wsl.onboarding.updatingCrokcode": "Actualizando CrokCode...",
  "wsl.onboarding.updatingCrokcodeIn": "Actualizando CrokCode en {{distro}}...",
  "wsl.onboarding.updateCrokcodeIn": "Actualiza CrokCode en {{distro}}.",
  "wsl.onboarding.updateCrokcode": "Actualizar CrokCode",
  "wsl.onboarding.crokcodeReadyIn": "CrokCode está listo en {{distro}}.",
  "wsl.onboarding.crokcodeReady": "CrokCode está listo.",
  "wsl.onboarding.installCrokcodeIn": "Instala CrokCode en {{distro}}.",
  "wsl.onboarding.installCrokcode": "Instalar CrokCode",
  ...
  "wsl.onboarding.distroStatus.crokcodeMissing": "CrokCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que CrokCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "CrokCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir CrokCode.",
  ...
  "toast.update.description": "Una nueva versión de CrokCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de CrokCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (crokcode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, CrokCode no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "CrokCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor CrokCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para CrokCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve CrokCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si CrokCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de CrokCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia CrokCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de CrokCode.",
