export const dict = {
  ...
  "dialog.provider.crokcode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.crokcode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.crokcodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من CrokCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في CrokCode.",
  ...
  "provider.connect.crokcodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.crokcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.crokcodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في CrokCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في CrokCode.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في crokcode.json",
  ...
  "dialog.server.description": "تبديل خادم CrokCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingCrokcode": "جارٍ التحقق من CrokCode...",
  "wsl.onboarding.checkingCrokcodeIn": "جارٍ التحقق من CrokCode في {{distro}}...",
  "wsl.onboarding.updatingCrokcode": "جارٍ تحديث CrokCode...",
  "wsl.onboarding.updatingCrokcodeIn": "جارٍ تحديث CrokCode في {{distro}}...",
  "wsl.onboarding.updateCrokcodeIn": "حدّث CrokCode في {{distro}}.",
  "wsl.onboarding.updateCrokcode": "تحديث CrokCode",
  "wsl.onboarding.crokcodeReadyIn": "CrokCode جاهز في {{distro}}.",
  "wsl.onboarding.crokcodeReady": "CrokCode جاهز.",
  "wsl.onboarding.installCrokcodeIn": "ثبّت CrokCode في {{distro}}.",
  "wsl.onboarding.installCrokcode": "تثبيت CrokCode",
  ...
  "wsl.onboarding.distroStatus.crokcodeMissing": "CrokCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن CrokCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على CrokCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح CrokCode.",
  ...
  "toast.update.description": "نسخة جديدة من CrokCode ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق CrokCode",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (crokcode.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن CrokCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن CrokCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم CrokCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ CrokCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور CrokCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان CrokCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة CrokCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل CrokCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من CrokCode.",
