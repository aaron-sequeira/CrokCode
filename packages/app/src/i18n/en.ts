export const dict = {
  ...
  "dialog.provider.crokcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.crokcode.tagline": "Reliable optimized models",
  "dialog.provider.crokcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by CrokCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CrokCode.",
  ...
  "provider.connect.crokcodeZen.visit.prefix": "Visit ",
  "provider.connect.crokcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.crokcodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CrokCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CrokCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in crokcode.json",
  ...
  "dialog.server.description": "Switch which CrokCode server this app connects to.",
  ...
  "wsl.onboarding.checkingCrokcode": "Checking CrokCode...",
  "wsl.onboarding.checkingCrokcodeIn": "Checking CrokCode in {{distro}}...",
  "wsl.onboarding.updatingCrokcode": "Updating CrokCode...",
  "wsl.onboarding.updatingCrokcodeIn": "Updating CrokCode in {{distro}}...",
  "wsl.onboarding.updateCrokcodeIn": "Update CrokCode in {{distro}}.",
  "wsl.onboarding.updateCrokcode": "Update CrokCode",
  "wsl.onboarding.crokcodeReadyIn": "CrokCode is ready in {{distro}}.",
  "wsl.onboarding.crokcodeReady": "CrokCode is ready.",
  "wsl.onboarding.installCrokcodeIn": "Install CrokCode in {{distro}}.",
  "wsl.onboarding.installCrokcode": "Install CrokCode",
  ...
  "wsl.onboarding.distroStatus.crokcodeMissing": "CrokCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before CrokCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "CrokCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen CrokCode.",
  ...
  "toast.update.description": "A new version of CrokCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the CrokCode team",
  ...
  "error.chain.checkConfig": "Check your config (crokcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CrokCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CrokCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the CrokCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for CrokCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how CrokCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether CrokCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CrokCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CrokCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CrokCode.",
