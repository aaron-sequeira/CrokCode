...
export const dict = {
  ...
  "dialog.provider.crokcode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.crokcode.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.crokcodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "CrokCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve CrokCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.crokcodeZen.visit.prefix": "",
  "provider.connect.crokcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.crokcodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak CrokCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak CrokCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler crokcode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi CrokCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingCrokcode": "CrokCode kontrol ediliyor...",
  "wsl.onboarding.checkingCrokcodeIn": "{{distro}} içinde CrokCode kontrol ediliyor...",
  "wsl.onboarding.updatingCrokcode": "CrokCode güncelleniyor...",
  "wsl.onboarding.updatingCrokcodeIn": "{{distro}} içinde CrokCode güncelleniyor...",
  "wsl.onboarding.updateCrokcodeIn": "{{distro}} içindeki CrokCode'u güncelleyin.",
  "wsl.onboarding.updateCrokcode": "CrokCode'u güncelle",
  "wsl.onboarding.crokcodeReadyIn": "{{distro}} içinde CrokCode hazır.",
  "wsl.onboarding.crokcodeReady": "CrokCode hazır.",
  "wsl.onboarding.installCrokcodeIn": "CrokCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installCrokcode": "CrokCode'u kur",
  ...
  "wsl.onboarding.distroStatus.crokcodeMissing": "CrokCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CrokCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "CrokCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından CrokCode'u tekrar açın.",
  ...
  "toast.update.description": "CrokCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı CrokCode ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (crokcode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: CrokCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "CrokCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "CrokCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "CrokCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "CrokCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "CrokCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "CrokCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "CrokCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "CrokCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "CrokCode'un en son sürümünü kullanıyorsunuz.",
