export const dict = {
  ...
  "dialog.provider.crokcode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.crokcode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.crokcodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af CrokCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i CrokCode.",
  ...
  "provider.connect.crokcodeZen.visit.prefix": "Besøg ",
  "provider.connect.crokcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.crokcodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i CrokCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i CrokCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i crokcode.json",
  ...
  "dialog.server.description": "Skift hvilken CrokCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingCrokcode": "Tjekker CrokCode...",
  "wsl.onboarding.checkingCrokcodeIn": "Tjekker CrokCode i {{distro}}...",
  "wsl.onboarding.updatingCrokcode": "Opdaterer CrokCode...",
  "wsl.onboarding.updatingCrokcodeIn": "Opdaterer CrokCode i {{distro}}...",
  "wsl.onboarding.updateCrokcodeIn": "Opdater CrokCode i {{distro}}.",
  "wsl.onboarding.updateCrokcode": "Opdater CrokCode",
  ...
  "wsl.onboarding.distroStatus.crokcodeMissing": "CrokCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før CrokCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "CrokCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter CrokCode igen.",
  ...
  "toast.update.description": "En ny version af CrokCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CrokCode-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (crokcode.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, CrokCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "CrokCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør CrokCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CrokCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan CrokCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om CrokCode følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan CrokCode er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CrokCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CrokCode.",
