export const dict = {
  ...
  "dialog.provider.crokcode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.crokcode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.crokcodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par CrokCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans CrokCode.",
  ...
  "provider.connect.crokcodeZen.visit.prefix": "Visitez ",
  "provider.connect.crokcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.crokcodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans CrokCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans CrokCode.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans crokcode.json",
  ...
  "dialog.server.description": "Changez le serveur CrokCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingCrokcode": "Vérification d'CrokCode...",
  "wsl.onboarding.checkingCrokcodeIn": "Vérification d'CrokCode dans {{distro}}...",
  "wsl.onboarding.updatingCrokcode": "Mise à jour d'CrokCode...",
  "wsl.onboarding.updatingCrokcodeIn": "Mise à jour d'CrokCode dans {{distro}}...",
  "wsl.onboarding.updateCrokcodeIn": "Mettez à jour CrokCode dans {{distro}}.",
  "wsl.onboarding.updateCrokcode": "Mettre à jour CrokCode",
  "wsl.onboarding.crokcodeReadyIn": "CrokCode est prêt dans {{distro}}.",
  "wsl.onboarding.crokcodeReady": "CrokCode est prêt.",
  "wsl.onboarding.installCrokcodeIn": "Installez CrokCode dans {{distro}}.",
  "wsl.onboarding.installCrokcode": "Installer CrokCode",
  ...
  "wsl.onboarding.distroStatus.crokcodeMissing": "CrokCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'CrokCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "CrokCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez CrokCode.",
  ...
  "toast.update.description":
    "Une nouvelle version d'CrokCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe CrokCode",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (crokcode.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'CrokCode ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "CrokCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur CrokCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour CrokCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'CrokCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si CrokCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'CrokCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'CrokCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'CrokCode.",
