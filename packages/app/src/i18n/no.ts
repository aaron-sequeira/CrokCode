...
export const dict = {
  ...
  "dialog.provider.crokcode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.crokcode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.crokcodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av CrokCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i CrokCode.",
  ...
  "provider.connect.crokcodeZen.visit.prefix": "Besøk ",
  "provider.connect.crokcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.crokcodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i CrokCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i CrokCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i crokcode.json",
  ...
  "dialog.server.description": "Bytt hvilken CrokCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av CrokCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til CrokCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (crokcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at CrokCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "CrokCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør CrokCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for CrokCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan CrokCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om CrokCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan CrokCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når CrokCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av CrokCode.",
  ...
  "wsl.onboarding.checkingCrokcode": "Sjekker CrokCode...",
  "wsl.onboarding.checkingCrokcodeIn": "Sjekker CrokCode i {{distro}}...",
  "wsl.onboarding.updatingCrokcode": "Oppdaterer CrokCode...",
  "wsl.onboarding.updatingCrokcodeIn": "Oppdaterer CrokCode i {{distro}}...",
  "wsl.onboarding.updateCrokcodeIn": "Oppdater CrokCode i {{distro}}.",
  "wsl.onboarding.updateCrokcode": "Oppdater CrokCode",
  "wsl.onboarding.crokcodeReadyIn": "CrokCode er klar i {{distro}}.",
  "wsl.onboarding.crokcodeReady": "CrokCode er klar.",
  "wsl.onboarding.installCrokcodeIn": "Installer CrokCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.crokcodeMissing": "CrokCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før CrokCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "CrokCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter CrokCode på nytt.",
