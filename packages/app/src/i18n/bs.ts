export const dict = {
  ...
  "dialog.provider.crokcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.crokcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.crokcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje CrokCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u CrokCode-u.",
  ...
  "provider.connect.crokcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.crokcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.crokcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u CrokCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u CrokCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u crokcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se CrokCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingCrokcode": "Provjera CrokCode...",
  "wsl.onboarding.checkingCrokcodeIn": "Provjera CrokCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingCrokcode": "Ažuriranje CrokCode...",
  "wsl.onboarding.updatingCrokcodeIn": "Ažuriranje CrokCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateCrokcodeIn": "Ažuriraj CrokCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateCrokcode": "Ažuriraj CrokCode",
  "wsl.onboarding.crokcodeReadyIn": "CrokCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.crokcodeReady": "CrokCode je spreman.",
  "wsl.onboarding.installCrokcodeIn": "Instaliraj CrokCode u distribuciji {{distro}}.",
  "wsl.onboarding.installCrokcode": "Instaliraj CrokCode",
  ...
  "wsl.onboarding.distroStatus.crokcodeMissing": "CrokCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi CrokCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "CrokCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori CrokCode.",
  ...
  "toast.update.description": "Nova verzija CrokCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku CrokCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (crokcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: CrokCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CrokCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni CrokCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u CrokCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako CrokCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li CrokCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu CrokCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se CrokCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju CrokCode-a.",
