...
export const dict = {
  ...
  "dialog.provider.crokcode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.crokcode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.crokcodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von CrokCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in CrokCode zu nutzen.",
  ...
  "provider.connect.crokcodeZen.line1":
    "OpenCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.crokcodeZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.crokcodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.crokcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.crokcodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in CrokCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in CrokCode zu nutzen.",
  ...
  "dialog.plugins.empty": "In crokcode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den CrokCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.crokcode": "CrokCode",
  ...
  "wsl.onboarding.checkingCrokcode": "CrokCode wird geprüft...",
  "wsl.onboarding.checkingCrokcodeIn": "CrokCode in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingCrokcode": "CrokCode wird aktualisiert...",
  "wsl.onboarding.updatingCrokcodeIn": "CrokCode in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateCrokcodeIn": "Aktualisieren Sie CrokCode in {{distro}}.",
  "wsl.onboarding.updateCrokcode": "CrokCode aktualisieren",
  "wsl.onboarding.crokcodeReadyIn": "CrokCode ist in {{distro}} bereit.",
  "wsl.onboarding.crokcodeReady": "CrokCode ist bereit.",
  "wsl.onboarding.installCrokcodeIn": "Installieren Sie CrokCode in {{distro}}.",
  "wsl.onboarding.installCrokcode": "CrokCode installieren",
  ...
  "wsl.onboarding.distroStatus.crokcodeMissing": "CrokCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor CrokCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "CrokCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann CrokCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von CrokCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem CrokCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (crokcode.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: CrokCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "CrokCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "CrokCode Desktop",
  ...
  "settings.desktop.wsl.description": "CrokCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für CrokCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie CrokCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob CrokCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von CrokCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von CrokCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von CrokCode.",
