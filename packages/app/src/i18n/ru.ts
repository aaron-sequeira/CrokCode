export const dict = {
  ...
  "dialog.provider.crokcode.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.crokcode.tagline": "Надежные оптимизированные модели",
  "dialog.provider.crokcodeGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от CrokCode",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в CrokCode.",
  ...
  "provider.connect.crokcodeZen.visit.prefix": "Посетите ",
  "provider.connect.crokcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.crokcodeZen.visit.suffix": " чтобы получить ваш API ключ.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в CrokCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в CrokCode.",
  ...
  "dialog.plugins.empty": "Плагины настроены в crokcode.json",
  ...
  "dialog.server.description": "Переключите сервер CrokCode к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingCrokcode": "Проверка CrokCode...",
  "wsl.onboarding.checkingCrokcodeIn": "Проверка CrokCode в {{distro}}...",
  "wsl.onboarding.updatingCrokcode": "Обновление CrokCode...",
  "wsl.onboarding.updatingCrokcodeIn": "Обновление CrokCode в {{distro}}...",
  "wsl.onboarding.updateCrokcodeIn": "Обновите CrokCode в {{distro}}.",
  "wsl.onboarding.updateCrokcode": "Обновить CrokCode",
  "wsl.onboarding.crokcodeReadyIn": "CrokCode в {{distro}} готов к работе.",
  "wsl.onboarding.crokcodeReady": "CrokCode готов к работе.",
  "wsl.onboarding.installCrokcodeIn": "Установите CrokCode в {{distro}}.",
  "wsl.onboarding.installCrokcode": "Установить CrokCode",
  ...
  "wsl.onboarding.distroStatus.crokcodeMissing": "CrokCode не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в CrokCode требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "CrokCode не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте CrokCode.",
  ...
  "toast.update.description": "Новая версия CrokCode ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде CrokCode",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (crokcode.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что CrokCode пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "CrokCode включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер CrokCode внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения CrokCode",
  ...
  "settings.general.row.appearance.description": "Настройте как CrokCode выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли CrokCode системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление CrokCode.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске CrokCode",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию CrokCode.",
