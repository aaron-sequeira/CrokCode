export const dict = {
  ...
  "dialog.provider.crokcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.crokcode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.crokcodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo CrokCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no CrokCode.",
  ...
  "provider.connect.crokcodeZen.visit.prefix": "Visite ",
  "provider.connect.crokcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.crokcodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no CrokCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no CrokCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em crokcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor CrokCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingCrokcode": "Verificando o CrokCode...",
  "wsl.onboarding.checkingCrokcodeIn": "Verificando o CrokCode em {{distro}}...",
  "wsl.onboarding.updatingCrokcode": "Atualizando o CrokCode...",
  "wsl.onboarding.updatingCrokcodeIn": "Atualizando o CrokCode em {{distro}}...",
  "wsl.onboarding.updateCrokcodeIn": "Atualize o CrokCode em {{distro}}.",
  "wsl.onboarding.updateCrokcode": "Atualizar o CrokCode",
  "wsl.onboarding.crokcodeReadyIn": "O CrokCode está pronto em {{distro}}.",
  "wsl.onboarding.crokcodeReady": "O CrokCode está pronto.",
  "wsl.onboarding.installCrokcodeIn": "Instale o CrokCode em {{distro}}.",
  "wsl.onboarding.installCrokcode": "Instalar o CrokCode",
  ...
  "wsl.onboarding.distroStatus.crokcodeMissing": "CrokCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o CrokCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O CrokCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o CrokCode novamente.",
  ...
  "toast.update.description": "Uma nova versão do CrokCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do CrokCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (crokcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: CrokCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "CrokCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor CrokCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do CrokCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o CrokCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o CrokCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o CrokCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CrokCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CrokCode.",
