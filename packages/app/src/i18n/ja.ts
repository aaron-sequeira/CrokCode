export const dict = {
  ...
  "dialog.provider.crokcode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.crokcode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.crokcodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "CrokCodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、CrokCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.crokcodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.crokcodeZen.visit.prefix": " ",
  "provider.connect.crokcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.crokcodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCrokCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、CrokCodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "crokcode.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するCrokCodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingCrokcode": "CrokCodeを確認中...",
  "wsl.onboarding.checkingCrokcodeIn": "{{distro}}内のCrokCodeを確認中...",
  "wsl.onboarding.updatingCrokcode": "CrokCodeを更新中...",
  "wsl.onboarding.updatingCrokcodeIn": "{{distro}}内のCrokCodeを更新中...",
  "wsl.onboarding.updateCrokcodeIn": "{{distro}}内のCrokCodeを更新してください。",
  "wsl.onboarding.updateCrokcode": "CrokCodeを更新",
  "wsl.onboarding.crokcodeReadyIn": "{{distro}}内のCrokCodeの準備ができました。",
  "wsl.onboarding.crokcodeReady": "CrokCodeの準備ができました。",
  "wsl.onboarding.installCrokcodeIn": "{{distro}}にCrokCodeをインストールしてください。",
  "wsl.onboarding.installCrokcode": "CrokCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.crokcodeMissing": "CrokCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CrokCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、CrokCodeをもう一度開いてください。",
  ...
  "toast.update.description": "CrokCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCrokCodeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (crokcode.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: CrokCodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "CrokCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCrokCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "CrokCodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのCrokCodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "CrokCodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "CrokCodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "CrokCode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "CrokCode は最新バージョンです。",
