...
import type { Config, CrokcodeClient, Project, Session } from "@crokcode/sdk/v2/client"
import type { NormalizedProviderListResponse } from "@crokcode/session-ui/context"
...
describe("query keys", () => {
  test("partitions identical directories by server scope", () => {
    const client = {} as CrokcodeClient
