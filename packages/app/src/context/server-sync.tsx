...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: CrokcodeClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: CrokcodeClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: CrokcodeClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => CrokcodeClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, CrokcodeClient>()
