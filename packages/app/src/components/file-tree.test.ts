...
beforeAll(async () => {
  ...
  mock.module("@crokcode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@crokcode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@crokcode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@crokcode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
